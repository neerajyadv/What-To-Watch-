...
class RecyclerAdapterLatestMovies extends RecyclerView.Adapter<RecyclerAdapterLatestMovies.DataViewHolder>
{
    private ArrayList<MoviesAndShowsData> arrayList;
    private Context context;

    RecyclerAdapterLatestMovies(ArrayList<MoviesAndShowsData> arrayList, Context context)
    {
    ...
    @Override
    public RecyclerAdapterLatestMovies.DataViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(RecyclerAdapterLatestMovies.DataViewHolder holder, final int position) {
