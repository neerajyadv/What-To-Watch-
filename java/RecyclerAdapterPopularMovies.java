...
class RecyclerAdapterPopularMovies extends RecyclerView.Adapter<RecyclerAdapterPopularMovies.DataViewHolder>
{

    private ArrayList<MoviesAndShowsData> arrayList;
    private Context context;
    RecyclerAdapterPopularMovies(ArrayList<MoviesAndShowsData> arrayList, Context context)
    {
        this.arrayList=arrayList;
        this.context=context;
    }
    @Override
    public RecyclerAdapterPopularMovies.DataViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(RecyclerAdapterPopularMovies.DataViewHolder holder, final int position) {
