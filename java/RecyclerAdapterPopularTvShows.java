...
public class RecyclerAdapterPopularTvShows extends RecyclerView.Adapter<RecyclerAdapterPopularTvShows.DataViewHolder>
{
    private ArrayList<MoviesAndShowsData> arrayList;
    private Context context;

    RecyclerAdapterPopularTvShows(ArrayList<MoviesAndShowsData> arrayList, Context context)
    {
    ...
    @Override
    public RecyclerAdapterPopularTvShows.DataViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_layout, parent, false);
        RecyclerAdapterPopularTvShows.DataViewHolder dataViewHolder=new RecyclerAdapterPopularTvShows.DataViewHolder(view);
